...
(function($) {
    ...
    $.fn.fSelect = function(options) {
        ...
        fSelect.prototype = {
            create: function() {
                ...
                // var all_selected_html ='';
                // all_selected_html = '<div class="fs-option all-select"><span class="fs-checkbox"><i></i></span><div class="fs-option-label">전체</div></div>';
                ...
                // html = html.replace('{all-selected}', all_selected_html);
    ...
    // $(document).on('click', '.all-select',function(e){
