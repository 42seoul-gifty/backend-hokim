function pagenation(link, page, totalPage, options) {
  ...
  if (start > 0)
    innerHTML += `<a class = "btn blue-button" href= '${link}?page=${0}&${options()}' style="margin: 5px"> < </a>`;
  ...
  if (totalPage > last)
    innerHTML += `<a class = "btn blue-button" href='${link}?page=${totalPage}&${options()}' style="margin: 5px"> > </a>`;
